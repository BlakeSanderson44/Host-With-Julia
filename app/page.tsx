          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="relative">
              ...
              >
                {properties.map((property) => (
                  <div key={property.id} className="group bg-white rounded-2xl shadow-soft hover:shadow-large transition-all duration-300 overflow-hidden transform hover:-translate-y-2 flex-shrink-0 w-80">
            ...
            <div className="flex justify-center mt-8 space-x-2">
              {properties.map((_, index) => (
                <div key={index} className="w-2 h-2 bg-forest/30 rounded-full"></div>
              ))}
            </div>
          </div>
        </section>
