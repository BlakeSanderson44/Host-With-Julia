...
const aboutValuePillars: AboutSectionProps['valuePillars'] = [
  {
...
const aboutTimeSavings: AboutSectionProps['timeSavings'] = [
...
const aboutComparisonRows: AboutSectionProps['comparisonRows'] = [
  {
  ...
  return (
    <>
      ...
      <main id="main" className="pt-16">
        ...
        <AboutSection
          valuePillars={aboutValuePillars}
          timeSavings={aboutTimeSavings}
          comparisonRows={aboutComparisonRows}
        />
